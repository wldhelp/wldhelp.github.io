...
3. Скопировать текст ниже (или нажать кнопку с квадратами справа):
...
5. В созданном файле по пустому полю щелкнуть **правой кнопкой** мышки. Нажать **Вставить**.
6. Напиши название своего поста в поле **title** в кавычках.
7. Напиши свой пост там, где написано **Текст поста.**
8. Чтобы опубликовать пост, нажми кнопку **Опубликовать в Интернет**.
9. Через минуту пост будет доступен в твоём блоге: [wladimirvoronin.github.io](https://wladimirvoronin.github.io)
