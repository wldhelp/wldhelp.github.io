...
Для удобства можно открыть данную справку в браузере. Для этого нажмите сверху-справа значок квадрата со стрелкой вверх (Открыть в браузере).
...
```
**Примечание:** чтобы скопировать, выделите текст и нажмите `CTRL+C` (C - это Copy, т.е. Копировать). Если хотите копировать используя правую кнопку мыши, то тогда нужно открыть эту справку в браузере, нажав сверху-справа значок квадрата со стрелкой вверх (Открыть в браузере).<br/>
