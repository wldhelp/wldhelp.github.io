...
Для удобства можно открыть данную справку в браузере. Для этого нажмите сверху-справа значок квадрата со стрелкой вверх.
...
```
6. Сверху-слева нажми кнопку **(→)** (Загрузить на плату).
7. **Подождите** 10 секунд. **Всё!** Первая программа была написана и загружена на плату. Теперь, если отключить плату от компьютера и подключить к USB-блокопитанию, то она будет так же мигать.
...
## V. Ответы на самостоятельное изучение
